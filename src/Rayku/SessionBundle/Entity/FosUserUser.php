...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Rayku\SessionBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Rayku\SessionBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Rayku\SessionBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Rayku\SessionBundle\Entity\FosUserGroup $group)
    {
