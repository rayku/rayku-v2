...
sudo apt-get update
sudo apt-get install -yf --force-yes vim apache2 php5 php5-cli php5-curl php5-mysql php-pear php5-dev php-apc php5-mcrypt php5-gd python-software-properties git-core curl php5-mysql php5-intl mysql-client
